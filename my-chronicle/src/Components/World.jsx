...
export function World(){
  ...
  useEffect(()=>{
    ...
    axios (` https://newsapi.org/v2/top-headlines?country=jp&pageSize=3&apiKey=e3d9b1100f4a480fb9831e24ed16aacc`)
    .then((res)=>{
    ...
    axios(`https://newsapi.org/v2/top-headlines?country=eg&category=entertainment&pageSize=4&apiKey=e3d9b1100f4a480fb9831e24ed16aacc`)
    .then((res)=>{
      
        setMovie(res.data.articles)
    })

    axios(`https://newsapi.org/v2/top-headlines?country=it&category=business&pageSize=4&apiKey=e3d9b1100f4a480fb9831e24ed16aacc`)
    .then((res)=>{
